...
class ModalLogin extends Component {
    ...
    render() {
        return (
            <div>
                <div id="modalLogin" className={`login-modal modal fade ${this.props.showModal && !this.state.dismissModal ? 'show' : ''}`} style={{
                    display: `${this.props.showModal && !this.state.dismissModal ? 'block' : 'none'}`,
                ...
                <div className={`${this.props.showModal && !this.state.dismissModal ? 'modal-backdrop fade show' : ''}`}></div>
            </div>
        )
    }
}
